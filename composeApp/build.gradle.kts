...
android { namespace = "dev.vespera.player"; compileSdk = 35
    defaultConfig { applicationId = "dev.vespera.player"; minSdk = 26; targetSdk = 35; versionCode = 1; versionName = "1.0.0" }
...
compose.desktop { application { mainClass = "dev.vespera.player.MainKt"; nativeDistributions { targetFormats(TargetFormat.Deb, TargetFormat.Rpm); packageName = "Vespera"; packageVersion = "1.0.0" } } }
